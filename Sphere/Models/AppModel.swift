...
final class AppModel {
    ...
    init(
        ...
        clientFactory: @escaping @MainActor (APIProfile) -> any ProxyBackendClient =
            BackendClientFactory.make(profile:)
    ) {
        self.defaults = defaults
        self.profileStore = ProfileStore(
            defaults: defaults, loadsProfilesImmediately: loadsProfilesImmediately)
